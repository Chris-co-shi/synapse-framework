...
/**
 * 将 Spring Security Authentication 桥接到 Synapse CurrentPrincipalContext 和 OperationContext。
 *
 ...
 *
 * <p>建立 Synapse scope 后，后续调用链可以读取当前主体或
 ...
 */
public final class SynapsePrincipalContextBridgeFilter extends OncePerRequestFilter {

    /**
     * 在当前 HTTP 请求作用域内建立并清理 Synapse 主体上下文。
     */
    @Override
