...
class BusinessExceptionTest {
    ...
    void shouldKeepErrorCodeAndDefaultMessage() {
        BusinessException exception = new BusinessException(CommonErrorCode.COMMON_CONFLICT);
    ...
    void shouldAllowCustomMessage() {
        BusinessException exception = new BusinessException(CommonErrorCode.COMMON_BAD_REQUEST, "字段不能为空");
