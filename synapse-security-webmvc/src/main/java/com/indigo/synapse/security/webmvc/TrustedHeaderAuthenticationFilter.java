...
public class TrustedHeaderAuthenticationFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        try {
            ...
            try (SecurityContextScope ignored = authenticate(headers, trustedHeader)) {
                chain.doFilter(request, response);
            }
    ...
    private SecurityContextScope authenticate(Map<String, String> headers, SynapseSecurityProperties.TrustedHeader trustedHeader) {
